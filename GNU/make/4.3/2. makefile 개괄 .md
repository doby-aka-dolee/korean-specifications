...
*makefile*은 일반적으로 아래와 같은 구조의 규칙(Rule)들로 이루어져 있습니다.
```
...
타겟 하나당 여러개의 전제조건을 가질 수 있는데 실제로 이렇게 다수의 전제조건을 갖는 경우가 많습니다.
...
다만 각 줄 앞에는 무조건 탭 문자가 와야 합니다. 많이들 빼먹고 실수하는 부분이니 꼭 기억해두세요.
...
레시피는 대게 전제조건 파일들 중 수정된 파일이 있을 경우 실행되며 보통 타겟을 생성하는 역할을 합니다.
전제조건이 필수적으로 있어야 하는 것은 아닌데,
...
보다 자세한 내용은 [Writing Rules](https://www.gnu.org/software/make/manual/make.html#Rules)을 참고해주시기 바랍니다.
